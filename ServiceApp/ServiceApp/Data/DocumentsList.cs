namespace ServiceApp.Data
{
    ...
    {
        public Dictionary<string, bool> waterDocument = new Dictionary<string, bool>()
        {
        ...
        public Dictionary<string, bool> gasDocument = new Dictionary<string, bool>()
        {
        ...
        public Dictionary<string, bool> designerWaterDocument = new Dictionary<string, bool>()
        {
            { "Смета на ПиР", false },
            { "График проектирования", false }
        };

        public Dictionary<string, bool> designerGasDocument = new Dictionary<string, bool>()
        {
            { "Смета на ПиР", false },
            { "График проектирования", false }
        };

        public Dictionary<string, string> designerDataWaterDoc= new Dictionary<string, string>()
        {
        ...
        public Dictionary<string, string> designerDataWaterDocOne = new Dictionary<string, string>()
        {
            { "Диаметр (мм) трубопровода и протяженность линейного объекта (м)", "" }
        };

        public Dictionary<string, string> designerDataWaterDocTwo = new Dictionary<string, string>()
        {
            { "Диаметр (мм) трубопровода и протяженность линейного объекта (м).", "" },
            { "Сметная стоимость работ, тыс. руб.", "" },
            { "Срок разработки проектной документации, месяцев", "" }
